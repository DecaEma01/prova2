package progettoperproveDekGizPack1;
...
public class prova1 {
	...
	public static void main(String[] args) {
		...
		long UnixTime= 1614632104;
		DataMeteo obj = new DataMeteo(UnixTime);
		System.out.println(obj.confrontaData(UnixTime));
		...
		/*
		long UnixTime= 1614622425000L;
		
		
		Calendar calendario = Calendar.getInstance();
		calendario.setTimeInMillis(UnixTime);
		System.out.println(calendario.getTimeInMillis());
...
class DataMeteo {
	 ...
	 */
	protected long unixData;  //seconds from 1970
	 ...
	 */
	public int calcolaSettimana(long giorno) {     //throws exception
